...
// Funktion som returnerar rätt poster baserat på film-ID
const getPosterById = (id) => {
  return posters[id] || ''; // Om inget matchande ID finns, returnera en tom sträng eller fallback-bild
};
